...
const char* dpt_button_id = "78602c36-e8b8-4639-9a55-981f7bac98c9";
const char* dpt_buzzer_id = "096b0b56-8f8b-420a-9db6-0701ff1ec9c5";
const char* dpt_co2_ppm_id = "7f5db806-c165-48d9-b55b-176149db95d6";
const char* dpt_current_a_id = "ec365eba-2b8e-4351-97ef-e68ec2d26040";
const char* dpt_heater_id = "43b8759b-2f34-46b3-b47d-a59a68296517";
const char* dpt_humidity_rh_id = "8843470c-79aa-4db9-944c-d02b3b6f8c35";
const char* dpt_led_id = "33cc94d0-5f0b-4846-921a-0d3f0280bc85";
...
const char* peripheral_voc_id = "fe969457-ad85-47c4-837a-20806f6f7379";
const char* peripheral_air_id = "ccb2841c-4d2d-46b6-834e-ff046adbcd00";
const char* peripheral_status_led_id = "1fb3a817-5310-4e14-950b-c96b4761d49c";
...
void setRegisterFixedPeripherals(JsonObject msg) {
  ...
  fdpt["prefix"] = "humidity";
  fdpt = fdpts.add<JsonObject>();
  fdpt["fid"] = dpt_temperature_c_id;
  fdpt["prefix"] = "temperature";
...
const char* peripheral_led_fault_id = "d6b77a3f-9ed0-40e4-af72-b4b2568f7882";
const char* peripheral_led_alarm_1_id = "4da21546-078d-4e0d-a036-e20fb078627f";
const char* peripheral_led_alarm_2_id = "49dd5e23-f604-4005-9358-136c0e38bb9c";
const char* peripheral_led_alarm_3_id = "f0d80afb-c621-4744-87dc-69b6d43db857";
const char* peripheral_led_alarm_4_id = "4cf0df60-d90d-4852-aad7-e7f92af378ba";
const char* peripheral_led_network_id = "f163f9e8-2061-4064-ae11-77848ad80fb5";

const char* peripheral_touch_1_id = "3b3a7020-1d56-4936-a8d4-ec175c56d824";
const char* peripheral_touch_2_id = "3786e671-d0f3-4cd1-8bb2-9f848b2c328d";

const char* peripheral_buzzer_id = "d9d6f349-7e99-4d98-b101-1716b677e60b";

const char* peripheral_relay_1_id = "3a5aad16-e08e-4133-8fd6-0fa97ba7ba66";
const char* peripheral_relay_2_id = "80c226b8-e139-4ae9-9236-7387279203ac";
const char* peripheral_relay_3_id = "ff0d15a8-0fd0-4f5a-b9e6-c4990d2b7a4b";
const char* peripheral_relay_4_id = "475904d6-bd33-4392-84dd-5937a97cd7db";

const char* peripheral_i2c_adapter_id = "e5890186-337f-4128-bd2f-aa20be0c1afc";
const char* peripheral_analog_out_id = "07f0907d-40f0-4027-b71f-c419eb6b6ac0";

const char* peripheral_modbus_client_id =
    "d4a92657-d4bc-490a-95e6-2ff9113c4852";
const char* peripheral_modbus_sensor_in_id =
    "42bf607e-8079-4683-981c-1748acd4f703";
const char* peripheral_modbus_sensor_out_id =
    "9499bab8-9809-431d-927f-fe42b94aa5dd";
...
void setRegisterFixedPeripherals(JsonObject msg) {
  ...
  JsonArray fdpts = fp["fdpts"].to<JsonArray>();
  addDptToJson(dpt_co2_ppm_id, "co2", fdpts);
  addDptToJson(dpt_voc_index_id, "voc", fdpts);
  addDptToJson(dpt_humidity_rh_id, "humidity", fdpts);
  addDptToJson(dpt_temperature_c_id, "temperature", fdpts);
}
...
const utils::UUID peripheral_heartbeat_led_id =
    "db15eb0d-95d9-47ff-8662-80fd29c9d53c";
const utils::UUID peripheral_gsm_wifi_toggle_id =
    "98da5466-02b2-44f4-b9c6-2538b11b4421";
const utils::UUID peripheral_maintenance_button_id =
    "abab7564-2969-468e-9fa9-a1d4c95d545f";
...
const char* config_1 = R"([
{"type":"I2CAdapter","uuid":"2f99965f-ce6d-44dc-81cb-75f9e6afaf3c","scl":8,"sda":9},
...
const char* config_2 = R"([
{"type":"DigitalOut","pin":2,"dpt":"33cc94d0-5f0b-4846-921a-0d3f0280bc85","uuid":"db15eb0d-95d9-47ff-8662-80fd29c9d53c"},
{"type":"DigitalIn","pin":14,"input_type":"floating","active_low":true,"dpt":"78602c36-e8b8-4639-9a55-981f7bac98c9","uuid":"98da5466-02b2-44f4-b9c6-2538b11b4421"},
{"type":"DigitalIn","pin":15,"input_type":"floating","active_low":true,"dpt":"78602c36-e8b8-4639-9a55-981f7bac98c9","uuid":"abab7564-2969-468e-9fa9-a1d4c95d545f"},
...
void setRegisterFixedPeripherals(JsonObject msg) {
  ...
  fp = fps.add<JsonObject>();
  fp["fid"] = peripheral_maintenance_button_id;
  fdpts = fp["fdpts"].to<JsonArray>();
