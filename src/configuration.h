...
extern StaticJsonDocument<JSON_PAYLOAD_SIZE> doc_in;
extern StaticJsonDocument<JSON_PAYLOAD_SIZE> doc_out;

// Server certificate authorities TLS certificates
const char default_root_ca[] PROGMEM = R"EOF(-----BEGIN CERTIFICATE-----
